 ...
 */
public class SenderWithLargestWordCount2284_co {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new SenderWithLargestWordCount2284_co().largestWordCount(messages, senders));
    }
    ...
    int compare(Map.Entry<String, List<String>> o1, Map.Entry<String, List<String>> o2) {
        ...
        String a = Collections.max(o1.getValue(), Comparator.comparingInt(String::length));
        String b = Collections.max(o2.getValue(), Comparator.comparingInt(String::length));

        return b.compareTo(a);
    }

    public String largestWordCount(String[] messages, String[] senders) {
        Map<String, List<String>> senderAndWords = new HashMap<>();
        ...
        for (int i = 0; i < messages.length; i++) {
            ...
            senderAndWords.computeIfAbsent(senders[i], k -> new ArrayList<>());
            senderAndWords.get(senders[i]).addAll(Arrays.asList(words));
        }

        int maxValue = Collections.max(senderWithWordCount.values());

        PriorityQueue<Map.Entry<String, List<String>>> pq = new PriorityQueue<>((a, b) -> compare(a, b));

        for (Map.Entry<String, List<String>> entry : senderAndWords.entrySet()) {
